...
# P2(x) = -2(x^2 - 25)(x^2 + 1) / 650
def p2(x):
    return -2 * (x**2 - 25) * (x**2 + 1) / 650

# Polynomial 3: Degree 6
# P3(x) = -2(x^2 - 25)(x^2 + 4)(x^2 + 9) / 23400
def p3(x):
    return -2 * (x**2 - 25) * (x**2 + 4) * (x**2 + 9) / 23400

# Polynomial 4: Degree 4 with different shape
# P4(x) = -2(x^2 - 25)(x^2 + 16) / 1025
def p4(x):
    return -2 * (x**2 - 25) * (x**2 + 16) / 1025

# Polynomial 5: Degree 8
# P5(x) = -2(x^2 - 25)(x^2 + 1)(x^2 + 4)(x^2 + 16) / 416000
def p5(x):
    return -2 * (x**2 - 25) * (x**2 + 1) * (x**2 + 4) * (x**2 + 16) / 416000

# Polynomial 6: Degree 6 with asymmetric additional factors
# P6(x) = -2(x^2 - 25)(x^2 + 6x + 10)(x^2 - 6x + 10) / 62500
def p6(x):
    return -2 * (x**2 - 25) * (x**2 + 6*x + 10) * (x**2 - 6*x + 10) / 62500
...
plot_path = os.path.join(base_dir, '../Plots/Wave_25NU_wavelets_Orthogonal/')
...
init_cond = []
for i in range(1):
    init_cond.append([BundleIBVP1D(t_min=t_min, t_min_val=lambda x: R_wavelet_POS(x,4,0),
            x_min = x_min*2 ,x_min_val= lambda t: 0,
            x_max = x_max*2 ,x_max_val= lambda t: 0),
        BundleIBVP1D(t_min=t_min, t_min_val=lambda x: R_wavelet_POS(x,3.0,-1),
            x_min = x_min*2 ,x_min_val= lambda t: 0,
            x_max = x_max*2 ,x_max_val= lambda t: 0),
        BundleIBVP1D(t_min=t_min, t_min_val=lambda x: R_wavelet_POS(x,3.0,1),
            x_min = x_min*2 ,x_min_val= lambda t: 0,
            x_max = x_max*2 ,x_max_val= lambda t: 0),
        BundleIBVP1D(t_min=t_min, t_min_val=lambda x: R_wavelet_POS(x,2.0,-1),
            x_min = x_min*2 ,x_min_val= lambda t: 0,
            x_max = x_max*2 ,x_max_val= lambda t: 0),
        BundleIBVP1D(t_min=t_min, t_min_val=lambda x: R_wavelet_POS(x,2.0,0),
            x_min = x_min*2 ,x_min_val= lambda t: 0,
            x_max = x_max*2 ,x_max_val= lambda t: 0),
        BundleIBVP1D(t_min=t_min, t_min_val=lambda x: R_wavelet_POS(x,2.0,1),
            x_min = x_min*2 ,x_min_val= lambda t: 0,

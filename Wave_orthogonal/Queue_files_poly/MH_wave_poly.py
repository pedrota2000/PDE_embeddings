...
plot_path = os.path.join(base_dir, '../Plots/Wave_25NU_poly_Orthogonal/')
...
for i in range(1):
    init_cond.append([
        BundleIBVP1D(t_min=t_min, t_min_val=lambda x: p1(x),
            x_min = x_min*2 ,x_min_val= lambda t: 0,
            x_max = x_max*2 ,x_max_val= lambda t: 0),
        BundleIBVP1D(t_min=t_min, t_min_val=lambda x: p2(x),
            x_min = x_min*2 ,x_min_val= lambda t: 0,
            x_max = x_max*2 ,x_max_val= lambda t: 0),
        BundleIBVP1D(t_min=t_min, t_min_val=lambda x: p3(x),
            x_min = x_min*2 ,x_min_val= lambda t: 0,
            x_max = x_max*2 ,x_max_val= lambda t: 0),
        BundleIBVP1D(t_min=t_min, t_min_val=lambda x: p4(x),
            x_min = x_min*2 ,x_min_val= lambda t: 0,
            x_max = x_max*2 ,x_max_val= lambda t: 0),
        BundleIBVP1D(t_min=t_min, t_min_val=lambda x: p5(x),
            x_min = x_min*2 ,x_min_val= lambda t: 0,
            x_max = x_max*2 ,x_max_val= lambda t: 0),
        BundleIBVP1D(t_min=t_min, t_min_val=lambda x: p6(x),
            x_min = x_min*2 ,x_min_val= lambda t: 0,
            x_max = x_max*2 ,x_max_val= lambda t: 0)
    ])
